...
from ..modules.extended_string.extended_string_function_mapper import (
    ExtendedStringFunctionMapper,
)
from ..modules.regexp.regexp_function_mapper import RegexpFunctionMapper
from ..modules.enhanced_aggregate.enhanced_aggregate_function_mapper import (
...
class FunctionMapper:
    ...
    def map_function(
        self, function_name: str, args: List[Any] = None, context: str = None
    ) -> Dict[str, Any]:
        ...
        try:
            if category == "enhanced_aggregate":
                ...
                return self.enhanced_aggregate_mapper.map_enhanced_aggregate_function(
                    function_name,
                    str(args) if args else "",
                    f"{function_name}({', '.join(str(arg) for arg in args) if args else ''})",
                )
                ...
                if args and len(args) > 0:
                    ...
                    return self.aggregate_mapper.map_function(
                        function_name, field, args
                    )
                else:
                ...
                return self.extended_string_mapper.map_extended_string_function(
                    function_name, args
                )
    ...
    def is_aggregate_function(self, function_name: str) -> bool:
        ...
        return self.enhanced_aggregate_mapper.is_supported_enhanced_aggregate(
            function_name
        ) or self.aggregate_mapper.is_aggregate_function(function_name)
    ...
    def is_encryption_function(self, function_name: str) -> bool:
        ...
        return self.encryption_mapper.is_function_supported(function_name)
    ...
    def map_regexp_expression(
        self, expression: str, context: str = "SELECT", alias: str = None
    ...
    def get_all_supported_functions(self) -> Dict[str, List[str]]:
        ...
        return {
            ...
            "encryption": self.encryption_mapper.get_supported_functions(),
        }
    ...
    def get_function_info(self, function_name: str) -> Dict[str, Any]:
        ...
        try:
            if category == "enhanced_aggregate":
                mapper_info = {
                    "description": f"Enhanced aggregate function: {function_name}",
                    "mongodb": "enhanced_pipeline",
                }
            elif category == "aggregate":
                ...
                mapper_info = (
                    self.conditional_mapper.get_function_info(func_upper) or {}
                )
            else:
                mapper_info = {}
